function countSubstringOccur(arr) {
    ...
    var result = 0;
    var index = 0;
    while (text.indexOf(word, index) != -1) { 	// The indexOf() method returns the position of the first occurrence of a specified value in a string.
        result++;								// This method returns -1 if the value to search for never occurs.
